 ...
 * @author Ruchir
 */
@WebServlet(name = "verwrk", urlPatterns = {"/verwrk"})
public class verwrk extends HttpServlet {
  ...
  static String city;
    ...
    preface.add(new Paragraph("This document gives the details of labours which are not yet paid for their work",
        smallBold));
  ...
  private static void createTable(Section subCatPart)
     ...
     //out.println("In Create TAble");
      ...
      ResultSet rst  = null;
        ...
        String sql = "Select * from workerdetails1 where Siteworkedat='"+city+"' AND Verifymoneyearned='no'";
        ...
        table.addCell(c1);
         ...
         c1 = new PdfPCell(new Phrase("Work From"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
    
             
        c1 = new PdfPCell(new Phrase("Work To"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
    ...
    list.add(new ListItem("For Site: "+city));
    
    list.add(new ListItem("Total Labours who are not paid: "+comp));
