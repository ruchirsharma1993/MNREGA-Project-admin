 ...
 * @author Ruchir
 */
@WebServlet(name = "listuprj", urlPatterns = {"/listuprj"})
public class listuprj extends HttpServlet {
     ...
     */
     private static String FILE = "D:\\uprjreport.pdf";
  ...
  static String city;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listuprj</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet listuprj at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
      ...
      document.close();
      out.println("Document generated at : D: \\ uprjreport.pdf");
      out.println("<br><br>");
      ...
      out.println("to Continue");
        ...
        {
            out.println("Exception in listprj.java"+e.getMessage());
        } finally {            
            out.close();
        }
    }
    ...
    preface.add(new Paragraph("This document gives the List of upcoming Sites City Wise. Tenders are invited for these sites. ",
        smallBold));
  ...
  private static void createTable(Section subCatPart)
     ...
     //out.println("In Create TAble");
      ...
      ResultSet rst  = null;
        ...
        String sql = "Select * from anncprj where city='"+city+"'";
        ...
        c1 = new PdfPCell(new Phrase("Date of Start"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
    ...
    list.add(new ListItem("Total Upcoming Sites: "+comp));
