 ...
 * @author Ruchir
 */
@WebServlet(name = "r100days", urlPatterns = {"/r100days"})
public class r100days extends HttpServlet {
     ...
     */
     private static String FILE = "D:\\exhaustlist.pdf";
  ...
  private static void addMetaData(Document document) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet r100days</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet r100days at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
      ...
      document.close();
       out.println("Document generated at : D:\\exhaustlist.pdf");
      out.println("<br><br>");
      out.println("Click");
    ...
    preface.add(new Paragraph("This document gives the details of Workers who have received less than 100 days of employment ",
        smallBold));
  ...
  private static void createTable(Section subCatPart)
     ...
     //out.println("In Create TAble");
      ...
      ResultSet rst  = null;
        ...
        c1 = new PdfPCell(new Phrase("Days Worked"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);

        c1 = new PdfPCell(new Phrase("Total money Earned"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
        ...
        c1 = new PdfPCell(new Phrase("No of Demands Fullfilled"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
        table.setHeaderRows(1);
        while(rst.next())
    ...
    list.add(new ListItem("Total Workers :"+worker));
    list.add(new ListItem("No. of workers who have less than 100 days of Employment: "+notemp));
