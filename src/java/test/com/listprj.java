 ...
 * @author Ruchir
 */
@WebServlet(name = "listprj", urlPatterns = {"/listprj"})
public class listprj extends HttpServlet {
     ...
     */
    private static String FILE = "D:\\prjreport.pdf";
  ...
  static String city;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      document.close();
      out.println("Document generated at : D:\\prjreport.pdf");
      out.println("<br><br>");
    ...
    preface.add(new Paragraph("This document gives the List of Sites City Wise ",
        smallBold));
  ...
  private static void createTable(Section subCatPart)
     ...
     //out.println("In Create TAble");
      ...
      ResultSet rst  = null;
        ...
        String sql = "Select * from site where city='"+city+"'";
