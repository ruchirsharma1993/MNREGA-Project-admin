 ...
 * @author Ruchir
 */
@WebServlet(name = "rcomp", urlPatterns = {"/rcomp"})
public class rcomp extends HttpServlet {
     ...
     */
    private static String FILE = "D:\\Complains.pdf";
  ...
  private static void addMetaData(Document document) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet rcomp</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet rcomp at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
      ...
      document.close();
      out.println("Document generated at : D:\\Complains.pdf");
      out.println("Click");
    ...
    preface.add(new Paragraph("This document gives the details of Complains that has been registered till date. ",
        smallBold));
  ...
  private static void createTable(Section subCatPart)
      throws Exception {
      int comp=0,solvdcomp=0,pendcomp=0,inprccomp=0;
     //out.println("In Create TAble");
      ...
      ResultSet rst  = null;
        ...
        PdfPCell c1 = new PdfPCell(new Phrase("Complain ID"));
        ...
        while(rst.next())
        {
            comp++;
                ...
                if(chl.equalsIgnoreCase("Solved"))
                    solvdcomp++;
                else if(chl.equalsIgnoreCase("InProcess"))
                    inprccomp++;
                else 
                    pendcomp++;
    ...
    list.add(new ListItem("Total Complains Registered till date :"+comp));
    list.add(new ListItem("Complains Solved: "+solvdcomp));
    list.add(new ListItem("Complains InProcess : "+inprccomp));
    list.add(new ListItem("Pending Complains : "+pendcomp));
