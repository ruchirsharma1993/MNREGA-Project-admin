 ...
 * @author Ruchir
 */
@WebServlet(name = "rstat", urlPatterns = {"/rstat"})
public class rstat extends HttpServlet {
     ...
     */
     private static String FILE = "D:\\statreport.pdf";
  ...
  private static void addMetaData(Document document) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet rstat</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet rstat at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
Document document = new Document();
      ...
      document.close();
      out.println("Document generated at : D:\\statreport.pdf");
      out.println("<br><br>");
    ...
    preface.add(new Paragraph("This document gives the details of Current Status of Sties ",
        smallBold));
